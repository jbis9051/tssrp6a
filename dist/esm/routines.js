...
import { bigIntToArrayBuffer, generateRandomBigInt, hash, hashPadded, stringToArrayBuffer, arrayBufferToBigInt, hashBitCount, } from "./utils.js";
/**
...
export class SRPRoutines {
    ...
    computeClientSessionKey(k, x, u, a, B) {
        const exp = u * x + a;
        const tmp = modPow(this.parameters.primeGroup.g, x, this.parameters.primeGroup.N) * k;
